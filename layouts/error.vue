<template>
  <v-app>
    <div class="h-screen w-full justify-centerc bg-img">
      <div class="w-full">
        <img src="@/assets/images/logo.png" alt="LAE" class="p-6 size-image flex" />
      </div>
      <section class="text-center section">
        <div class="max-w-auto mx-auto">
          ...
          <h2 class="mt-8 uppercase text-xl lg:text-5xl font-black">Sorry, Page not found!</h2>
          <p
          ...
          <v-btn large color="primary" class="px-12 mt-8" @click.prevent="back">Back</v-btn>
        </div>
      </section>
    </div>
  </v-app>
